...
INSERT INTO public.projects (id_lead, description, name) VALUES (1, 'Diff checking at scale', 'Conflate');
INSERT INTO public.projects (id_lead, description, name) VALUES (3, 'Our cloud storage offering', 'Contoso Cloud');
INSERT INTO public.projects (id_lead, description, name) VALUES (1, 'Team messaging & calls', 'Congregate');
...
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2024-06-12 18:00:00.000000', 4, 1, e'Our CI pipeline takes *way too long* to run, and some developers (not to be named) have taken to avoiding testing altogether.

We need to improve things', 'TODO', 'DevEx - Better rigs for everyone', 'TASK');
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2024-06-13 13:00:00.000000', 2, 1, '**Conflating** things is the opposite of <u>diff</u>erentiating them.', 'DOING', 'Find a better product name', 'STORY');
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2024-06-14 09:00:00.000000', 1, 2, e'* [x] Reproduce the issue
* [x] Find the cause
...
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2024-06-15 12:00:00.000000', 2, 2, e'* Obtinere proiecte proprii ale unui utilizator (inclusiv proiectele in care e membru)
  * GET /api/projects
...
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2025-01-15 23:09:00.000000', 1, 2, e'FREE & OPEN SOURCE
...
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2025-01-15 23:57:00.000000', 3, 2, 'There''s not much to it, we just need to show our work since last time', 'TODO', 'Prepare slide deck for VP meeting', 'TASK');
INSERT INTO public.issues (date, id_assignee, id_project, description, status, summary, type) VALUES ('2025-01-16 00:25:00.000000', 1, 3, e'Weirdly enough, this seems related to distance. Messages only start to disappear after \\~500 miles
...
INSERT INTO public.comments (date, id_issue, id_user, content) VALUES ('2024-06-13 10:00:00.000000', 1, 1, 'Seems good to me');
INSERT INTO public.comments (date, id_issue, id_user, content) VALUES ('2025-01-15 23:54:00.000000', 5, 3, 'I''ll need an update on this');
INSERT INTO public.comments (date, id_issue, id_user, content) VALUES ('2025-01-16 00:01:00.000000', 3, 3, 'This one''s rather unusual');
